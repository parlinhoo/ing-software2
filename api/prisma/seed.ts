...
async function main() {
  ...
  const incidentes: [string, string, string, number, number, number, number, string | null][] = [
    ...
    ['2026-03-11T14:45:00', 'Sala 3°A Medio', 'Daño deliberado al mobiliario del establecimiento (rayado de muros y rotura de silla).', 3, 4, 2, 9, null],
    ...
    ['2026-03-27T09:15:00', 'Biblioteca', 'Amenaza verbal hacia un compañero presenciada por otros estudiantes.', 2, 5, 2, 29, null],
    ...
    ['2026-04-10T16:30:00', 'Biblioteca', 'Estudiante difunde rumores ofensivos sobre una compañera en redes sociales.', 2, 3, 2, 24, null],
    ...
    ['2026-04-20T15:00:00', 'Baños del primer piso', 'Amenazas de violencia con objeto contundente hacia un compañero.', 3, 6, 2, 23, null],
    ...
    ['2026-05-12T10:45:00', 'Pasillo de salas', 'Negativa rotunda y agresiva ante una indicación del inspector de patio.', 2, 4, 2, 10, null],
  ...
  const intervenciones: [number, number, string, string, string][] = [
    ...
    // --- Acciones de seguimiento para incidentes cerrados que no tenían intervención ---
    [2, 5, '2026-03-06T11:00:00', 'Mediación entre pares', 'Se realiza mediación con presencia de orientador entre los estudiantes involucrados.'],
    [8, 6, '2026-03-16T15:00:00', 'Citación a apoderado', 'Se cita al apoderado para informar sobre la situación y acordar medidas formativas en conjunto.'],
    [8, 6, '2026-03-23T12:00:00', 'Acuerdo de reparación del daño', 'El estudiante repone el material dañado y firma compromiso de cuidado del mobiliario escolar.'],
    [9, 5, '2026-03-17T10:00:00', 'Conversación formativa', 'Conversación con el estudiante para reflexionar sobre el incidente y establecer compromisos.'],
    [12, 6, '2026-03-20T14:00:00', 'Diálogo restaurativo', 'Se realiza diálogo restaurativo entre las partes, con acuerdo de reparación.'],
    [25, 5, '2026-04-07T09:30:00', 'Conversación formativa', 'Conversación con el estudiante para reflexionar sobre el incidente y establecer compromisos.'],
    [29, 6, '2026-04-14T13:00:00', 'Citación a apoderado', 'Se cita al apoderado para informar sobre la situación y acordar medidas formativas en conjunto.'],
    [34, 5, '2026-04-25T11:00:00', 'Conversación formativa', 'Conversación con el estudiante para reflexionar sobre el incidente y establecer compromisos.'],
    [36, 6, '2026-05-02T10:00:00', 'Activación de protocolo de convivencia', 'Se activa el protocolo de convivencia escolar según reglamento interno.'],
    [36, 5, '2026-05-09T11:30:00', 'Derivación a orientación', 'Se deriva al estudiante a entrevista con orientador para evaluar acompañamiento.'],
    [40, 5, '2026-05-02T09:00:00', 'Conversación formativa', 'Conversación con el estudiante para reflexionar sobre el incidente y establecer compromisos.'],
    [43, 6, '2026-05-07T12:00:00', 'Conversación formativa', 'Conversación con el estudiante para reflexionar sobre el incidente y establecer compromisos.'],
    [48, 6, '2026-05-14T10:00:00', 'Activación de protocolo de convivencia', 'Se activa el protocolo de convivencia escolar según reglamento interno.'],
    [48, 5, '2026-05-21T13:00:00', 'Reunión con apoderados de ambas partes', 'Se cita a ambos apoderados para informar la situación y coordinar medidas.'],
    // --- (Opcional) Primera acción para incidentes 'En seguimiento' que estaban sin intervención ---
    [5, 5, '2026-03-13T11:30:00', 'Citación a apoderado', 'Se cita al apoderado para informar sobre la situación y acordar medidas formativas en conjunto.'],
    [15, 6, '2026-03-22T10:45:00', 'Derivación a orientación', 'Se deriva al estudiante a entrevista con orientador para evaluar acompañamiento.'],
    [16, 5, '2026-03-22T11:30:00', 'Mediación entre pares', 'Se realiza mediación con presencia de orientador entre los estudiantes involucrados.'],
    [26, 6, '2026-04-10T09:15:00', 'Conversación formativa', 'Conversación con el estudiante para reflexionar sobre el incidente y establecer compromisos.'],
    [31, 5, '2026-04-17T10:45:00', 'Activación de protocolo de convivencia', 'Se activa el protocolo de convivencia escolar según reglamento interno.'],
    [32, 6, '2026-04-24T12:45:00', 'Citación a apoderado', 'Se cita al apoderado para informar sobre la situación y acordar medidas formativas en conjunto.'],
    [39, 5, '2026-05-01T16:00:00', 'Derivación a orientación', 'Se deriva al estudiante a entrevista con orientador para evaluar acompañamiento.'],
    [42, 6, '2026-05-05T16:30:00', 'Mediación entre pares', 'Se realiza mediación con presencia de orientador entre los estudiantes involucrados.'],
    [46, 5, '2026-05-09T15:00:00', 'Conversación formativa', 'Conversación con el estudiante para reflexionar sobre el incidente y establecer compromisos.'],
    [50, 6, '2026-05-16T16:30:00', 'Activación de protocolo de convivencia', 'Se activa el protocolo de convivencia escolar según reglamento interno.'],
  ];
